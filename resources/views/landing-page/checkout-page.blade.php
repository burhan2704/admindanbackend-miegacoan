...
<html
  ...
  <head>
    ...
    <title>Checkout Card - Front Pages | Materialize - Material Design HTML Admin Template</title>
    ...
    <link rel="stylesheet" href="{{ asset('core-template/assets/vendor/fonts/remixicon/remixicon.css') }}" />

    <!-- Menu waves for no-customizer fix -->
    <link rel="stylesheet" href="{{ asset('core-template/assets/vendor/libs/node-waves/node-waves.css') }}" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('core-template/assets/vendor/css/rtl/core.css') }}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('core-template/assets/vendor/css/rtl/theme-default.css') }}" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="{{ asset('core-template/assets/css/demo.css') }}" />
    <link rel="stylesheet" href="{{ asset('core-template/assets/vendor/css/pages/front-page.css') }}" />

    <!-- Vendors CSS -->
    <link rel="stylesheet" href="{{ asset('core-template/assets/vendor/libs/select2/select2.css') }}" />
    <link rel="stylesheet" href="{{ asset('core-template/assets/vendor/libs/bs-stepper/bs-stepper.css') }}" />
    <link rel="stylesheet" href="{{ asset('core-template/assets/vendor/libs/rateyo/rateyo.css') }}" />
    <link rel="stylesheet" href="{{ asset('core-template/assets/vendor/libs/@form-validation/form-validation.css') }}" />

    <!-- Page CSS -->
    <link rel="stylesheet" href="{{ asset('core-template/assets/vendor/css/pages/wizard-ex-checkout.css') }}" />
    ...
    <script src="{{ asset('core-template/assets/js/front-config.js') }}"></script>
  </head>

  <body>
    <script src="{{ asset('core-template/assets/vendor/js/dropdown-hover.js') }}"></script>
    <script src="{{ asset('core-template/assets/vendor/js/mega-dropdown.js') }}"></script>
                ...
                <div class="row gy-4">
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="bg-body nav-img-col p-2">
                      <img
                        src="{{ asset('core-template/assets/img/front-pages/misc/nav-item-col-img-light.png') }}"
          ...
          <div class="bs-stepper-header m-auto border-0">
              ...
              <button type="button" class="step-trigger">
                <span class="bs-stepper-icon">
                  <svg viewBox="0 0 58 54">
                    <use xlink:href="core-template/assets/svg/icons/wizard-checkout-cart.svg#wizardCart"></use>
                  </svg>
                </span>
              ...
              <button type="button" class="step-trigger">
                <span class="bs-stepper-icon">
                  <svg viewBox="0 0 54 54">
                    <use xlink:href="core-template/assets/svg/icons/wizard-checkout-address.svg#wizardCheckoutAddress"></use>
                  </svg>
                </span>
            ...
            <div class="step" data-target="#checkout-payment">
              <button type="button" class="step-trigger">
                <span class="bs-stepper-icon">
                  <svg viewBox="0 0 58 54">
                    <use xlink:href="core-template/assets/svg/icons/wizard-checkout-payment.svg#wizardPayment"></use>
                  </svg>
                </span>
            ...
            <div class="step" data-target="#checkout-confirmation">
              <button type="button" class="step-trigger">
                <span class="bs-stepper-icon">
                  <svg viewBox="0 0 58 54">
                    <use xlink:href="core-template/assets/svg/icons/wizard-checkout-confirmation.svg#wizardConfirm"></use>
                  </svg>
                </span>
                ...
                <div class="row">
                  ...
                  <div class="col-xl-8 mb-4 mb-xl-0">
                    ...
                    <ul class="list-group mb-4">
                      <li class="list-group-item p-5">
                        <div class="d-flex gap-4">
                          <div class="flex-shrink-0">
                            <img src="{{ asset('core-template/assets/img/products/1.png') }}" alt="google home" class="w-px-100" />
                          </div>
                          <div class="flex-grow-1">
                            <div class="row">
                              <div class="col-md-8">
                                ...
                                <div class="mb-2 d-flex flex-wrap">
                                  <span class="me-1 text-body">Sold by:</span>
                              ...
                              <div class="col-md-4">
                                <div class="text-md-end">
                                  <button
                                    type="button"
                                    class="btn text-muted p-0 shadow-none btn-pinned border-none"
                                    aria-label="Close">
                      ...
                      <li class="list-group-item p-5">
                        <div class="d-flex gap-4">
                          <div class="flex-shrink-0">
                            <img src="{{ asset('core-template/assets/img/products/2.png') }}" alt="google home" class="w-px-100" />
                          </div>
                          <div class="flex-grow-1">
                            <div class="row">
                              <div class="col-md-8">
                              ...
                              <div class="col-md-4">
                                <div class="text-md-end">
                                  ...
                                  <div class="mt-4 mt-md-6 mb-md-0">
                                    <span class="text-primary">$899/</span><s class="text-body">$999</s>
                                  </div>
                                  <button type="button" class="btn btn-sm btn-outline-primary mt-4">
                                    Move to wishlist
                                  </button>
                    ...
                    <div class="list-group">
                      <a
                        href="javascript:void(0)"
                        class="list-group-item text-primary d-flex justify-content-between border-primary rounded-3">
                    ...
                    <div class="border rounded-4 p-5 mb-4">
                      ...
                      <dl class="row mb-0">
                        ...
                        <dd class="col-6 text-end">
                          <s class="text-muted me-2">$5.00</s>
                      ...
                      <div class="col-md">
                        <div class="form-check custom-option custom-option-basic">
                          <label class="form-check-label custom-option-content" for="customRadioAddress2">
                            ...
                            <span class="custom-option-body">
                              <small class="d-xxl-block pe-xxl-12 me-xxl-12"
                                >8723 Schoffman Avenue, New York, NY, 10016.<br />Mobile : 1234567890 Cash / Card on
                    ...
                    <div class="border rounded-4 p-5 mb-4">
                      ...
                      <ul class="list-unstyled">
                        <li class="d-flex gap-4 mb-4">
                          <div class="flex-shrink-0">
                            <img src="{{ asset('core-template/assets/img/products/1.png') }}" alt="google home" class="w-px-50" />
                          </div>
                          <div class="flex-grow-1">
                            <p class="mb-0">
                        ...
                        <li class="d-flex gap-4">
                          <div class="flex-shrink-0">
                            <img src="{{ asset('core-template/assets/img/products/2.png') }}" alt="google home" class="w-px-50" />
                          </div>
                          <div class="flex-grow-1">
                            <p class="mb-0">
                  ...
                  <div class="col-xl-4">
                    <div class="border rounded-3 p-5">
                      ...
                      <dl class="row mb-0">
                        ...
                        <dt class="col-6 fw-normal text-heading">Delivery Charges</dt>
                        <dd class="col-6 text-end">
                          <s class="text-muted me-1">$5.00</s>
                          <span class="badge bg-label-success rounded-pill text-uppercase">Free</span>
                        </dd>
                      </dl>
                      <hr class="mx-n5 mt-1" />
              ...
              <div id="checkout-confirmation" class="content">
                <div class="row mb-6">
                  <div class="col-12 col-lg-8 mx-auto text-center mb-2">
                    ...
                    <p>
                      We sent an email to
                      <a href="mailto:john.doe@example.com" class="h6 mb-0">john.doe@example.com</a> with your order
                    ...
                    <p class="d-flex align-items-center justify-content-center">
                      <span><i class="ri-time-line ri-20px text-heading me-1"></i></span>Time placed: 25/05/2020 13:35pm
                    </p>
                  </div>
                    ...
                    <ul class="list-group list-group-horizontal-md">
                      <li class="list-group-item flex-fill p-5">
                        <h6 class="d-flex align-items-center gap-2">
                          <i class="ri-map-pin-line ri-20px"></i> Shipping
                        </h6>
                      ...
                      <li class="list-group-item flex-fill p-5">
                        <h6 class="d-flex align-items-center gap-2">
                          <i class="ri-bank-card-line ri-20px"></i> Billing Address
                        </h6>
                        <address class="text-body">
                          John Doe <br />
                          4135 Parkway Street,<br />
                      ...
                      <li class="list-group-item flex-fill p-5">
                        <h6 class="d-flex align-items-center gap-2">
                          <i class="ri-ship-2-line ri-20px"></i> Shipping Method
                        </h6>
                  ...
                  <div class="col-xl-9 mb-4 mb-xl-0">
                    <ul class="list-group">
                      <li class="list-group-item p-5">
                        <div class="d-flex gap-4">
                          <div class="flex-shrink-0">
                            <img src="{{ asset('core-template/assets/img/products/1.png') }}" alt="google home" class="w-px-75" />
                          </div>
                          <div class="flex-grow-1">
                              ...
                              <div class="col-md-4">
                                <div class="text-md-end">
                                  <div class="my-2 my-lg-6">
                                    <span class="text-primary">$299/</span><span class="text-muted">$359</span>
                                  </div>
                                </div>
                              </div>
                            </div>
                      ...
                      <li class="list-group-item p-5">
                        <div class="d-flex gap-4">
                          <div class="flex-shrink-0">
                            <img src="{{ asset('core-template/assets/img/products/2.png') }}" alt="google home" class="w-px-75" />
                          </div>
                          <div class="flex-grow-1">
                            <div class="row d-flex align-items-center">
                              <div class="col-md-8 pt-2">
                                ...
                                <div class="text-body mb-1 d-flex flex-wrap">
                                  <span class="me-1">Sold by:</span> <a href="javascript:void(0)" class="me-1">Apple</a>
                                </div>
                              </div>
                              <div class="col-md-4">
                                <div class="text-md-end">
                                  <div class="my-2 my-lg-6">
                                    <span class="text-primary">$899/</span><span class="text-muted">$999</span>
                                  </div>
                                </div>
                              </div>
                            </div>
    ...
    <footer class="landing-footer">
      <div class="footer-top position-relative overflow-hidden">
        <img
          src="{{ asset('core-template/assets/img/front-pages/backgrounds/footer-bg.png') }}"
          alt="footer bg"
          ...
          <div class="row gx-0 gy-7 gx-sm-6 gx-lg-12">
            ...
            <div class="col-lg-3 col-md-4">
              ...
              <a href="javascript:void(0);" class="d-block footer-link mb-4"
                ><img src="{{ asset('core-template/assets/img/front-pages/landing-page/apple-icon.png') }}" alt="apple icon"
              /></a>
              <a href="javascript:void(0);" class="d-block footer-link"
                ><img src="{{ asset('core-template/assets/img/front-pages/landing-page/google-play-icon.png') }}" alt="google play icon"
              /></a>
            </div>
          </div>
        </div>
    ...
    <script src="{{ asset('core-template/assets/vendor/libs/popper/popper.js') }}"></script>
    <script src="{{ asset('core-template/assets/vendor/js/bootstrap.js') }}"></script>
    <script src="{{ asset('core-template/assets/vendor/libs/node-waves/node-waves.js') }}"></script>

    <!-- endbuild -->

    <!-- Vendors JS -->
    <script src="{{ asset('core-template/assets/vendor/libs/jquery/jquery.js') }}"></script>
    <script src="{{ asset('core-template/assets/vendor/libs/select2/select2.js') }}"></script>
    <script src="{{ asset('core-template/assets/vendor/libs/bs-stepper/bs-stepper.js') }}"></script>
    <script src="{{ asset('core-template/assets/vendor/libs/rateyo/rateyo.js') }}"></script>
    <script src="{{ asset('core-template/assets/vendor/libs/cleavejs/cleave.js') }}"></script>
    <script src="{{ asset('core-template/assets/vendor/libs/cleavejs/cleave-phone.js') }}"></script>
    <script src="{{ asset('core-template/assets/vendor/libs/@form-validation/popular.js') }}"></script>
    <script src="{{ asset('core-template/assets/vendor/libs/@form-validation/bootstrap5.js') }}"></script>
    <script src="{{ asset('core-template/assets/vendor/libs/@form-validation/auto-focus.js') }}"></script>

    <!-- Main JS -->
    <script src="{{ asset('core-template/assets/js/front-main.js') }}"></script>

    <!-- Page JS -->

    <script src="{{ asset('core-template/assets/js/modal-add-new-address.js') }}"></script>
    <script src="{{ asset('core-template/assets/js/wizard-ex-checkout.js') }}"></script>
  </body>
</html>
