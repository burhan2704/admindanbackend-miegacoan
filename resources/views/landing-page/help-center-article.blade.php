...
<html
  ...
  <head>
    ...
    <title>Help center Page - Front Pages | Materialize - Material Design HTML Admin Template</title>
      ...
      <div class="container">
        <div class="row gy-6 gy-lg-0">
          <div class="col-lg-8">
            ...
            <div class="my-6">
              <img src="core-template/assets/img/front-pages/misc/product-image.png" alt="product" class="img-fluid w-100" />
            </div>
            <p class="mb-0">
            ...
            <div class="mt-6">
              <img src="core-template/assets/img/front-pages/misc/checkout-image.png" alt="product" class="img-fluid w-100" />
            </div>
          </div>
          <div class="col-lg-4">
