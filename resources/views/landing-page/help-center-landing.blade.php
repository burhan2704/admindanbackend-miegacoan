...
<html
  ...
  <head>
    ...
    <!-- Page CSS -->
    <link rel="stylesheet" href="core-template/assets/vendor/css/pages/front-page-help-center.css" />
  ...
  <body>
    ...
    <section class="section-py first-section-pt help-center-header position-relative overflow-hidden">
      <img
        ...
        src="core-template/assets/img/pages/header-light.png"
                    ...
                    <div class="d-flex align-items-center">
                      <div class="avatar avatar-sm flex-shrink-0 me-2">
                        <span class="avatar-initial bg-label-primary rounded-3"
                          ><i class="tf-icons ri-shopping-cart-line ri-20px"></i
                        ></span>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="avatar avatar-sm flex-shrink-0 me-2">
                        <span class="avatar-initial bg-label-primary rounded-3"
                          ><i class="tf-icons ri-question-line ri-20px"></i
                        ></span>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="avatar avatar-sm flex-shrink-0 me-2">
                        <span class="avatar-initial bg-label-primary rounded-3"
                          ><i class="tf-icons ri-file-text-line ri-20px"></i
                        ></span>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="avatar avatar-sm flex-shrink-0 me-2">
                        <span class="avatar-initial bg-label-primary rounded-3"
                          ><i class="tf-icons ri-palette-line ri-20px"></i
                        ></span>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="avatar avatar-sm flex-shrink-0 me-2">
                        <span class="avatar-initial bg-label-primary rounded-3"
                          ><i class="tf-icons ri-lock-line ri-20px"></i
                        ></span>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="avatar avatar-sm flex-shrink-0 me-2">
                        <span class="avatar-initial bg-label-primary rounded-3"
                          ><i class="tf-icons ri-user-line ri-20px"></i
                        ></span>
                      </div>
