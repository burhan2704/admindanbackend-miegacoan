...
<!-- Filter Section -->
@include("mie-gacoan.bill-of-material.search")
    ...
    $(document).ready(function() {
      ...
      dataTableIndex = $(".dataTableIndex").DataTable({
          ...
          ajax: {
              ...
              type: 'GET',
              data: {
                bom_code: () => { return $('#searchForm #bom_code').val() },
                bom_desc: () => { return $('#searchForm #bom_desc').val() },
                status: () => { return $('#searchForm #status').val() },
                prd_desc: () => { return $('#searchForm #prd_desc').val() },
              },
              timeout: 60 * 1000
          },
          dom: `
