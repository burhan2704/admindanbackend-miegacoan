...
<form id="searchForm" onsubmit="return false;">
  ...
  <div class="card card-body">
    ...
    <div class="row mb-3">
      ...
      <div class="col-md-4">
        <label for="filter-barcode" class="form-label">Trans No</label>
        <input type="text" id="trans_no"  name="trans_no" class="form-control" placeholder="">
      </div>

      <div class="col-md-4">
        <label for="filter-barcode" class="form-label">Store Name</label>
        <input type="text" id="store_name"  name="store_name" class="form-control" placeholder="">
      </div>
