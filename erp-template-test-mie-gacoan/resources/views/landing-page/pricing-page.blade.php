...
<html
  ...
  <head>
    ...
    <title>Pricing - Front Pages | Materialize - Material Design HTML Admin Template</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="core-template/assets/img/favicon/favicon.ico" />
    ...
    <!-- Page CSS -->
    <link rel="stylesheet" href="core-template/assets/vendor/css/pages/front-page-pricing.css" />
  ...
  <body>
                ...
                <div class="row gy-4">
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="bg-body nav-img-col p-2">
                      <img
                        src="core-template/assets/img/front-pages/misc/nav-item-col-img-light.png"
    ...
    <section class="section-py first-section-pt">
      <div class="container">
        ...
        <p class="text-center px-sm-12 mb-2">
          <span>All plans include 40+ advanced tools and features to boost your product.</span><br />Choose the best
            ...
            <div class="card border shadow-none">
              <div class="card-body pt-12">
                <div class="mt-3 mb-5 text-center">
                  <img src="core-template/assets/img/illustrations/pricing-basic.png" alt="Basic Image" height="120" />
                </div>
                ...
                <a href="payment-page.html" class="btn btn-outline-success d-grid w-100">Your Current Plan</a>
              </div>
            </div>
          </div>
            ...
            <div class="card border-primary border shadow-none">
              <div class="card-body position-relative pt-4">
                ...
                <div class="my-5 pt-6 text-center">
                  <img src="core-template/assets/img/illustrations/pricing-standard.png" alt="Standard Image" height="120" />
                </div>
          ...
          <div class="col-lg px-0">
            <div class="card border shadow-none">
              <div class="card-body pt-12">
                <div class="mt-3 mb-5 text-center">
                  <img
                    src="core-template/assets/img/illustrations/pricing-enterprise.png"
                ...
                <a href="payment-page.html" class="btn btn-outline-primary d-grid w-100">Upgrade</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="position-relative">
          <div class="d-flex justify-content-between flex-column-reverse flex-lg-row align-items-center py-12">
            ...
            <div class="text-center">
              <img
                src="core-template/assets/img/illustrations/pricing-illustration.png"
          ...
          <table class="table table-striped text-center mb-0">
            ...
            <tbody>
              ...
              <tr>
                <td></td>
                <td>
                  <a href="payment-page.html" class="btn text-nowrap btn-outline-primary">Choose Plan</a>
                </td>
                <td>
        ...
        <div id="faq" class="accordion">
          ...
          <div class="accordion-item">
            ...
            <div id="accordionPayment-4" class="accordion-collapse collapse">
              <div class="accordion-body">
                If you have paying users or you are developing any SaaS products then you need an Extended License. For
                each products, you need a license. You can get free lifetime updates as well.
              </div>
            </div>
          </div>
          ...
          <div class="row gx-0 gy-7 gx-sm-6 gx-lg-12">
            ...
            <div class="col-lg-3 col-md-4">
              ...
              <a href="javascript:void(0);" class="d-block footer-link mb-4"
                ><img src="core-template/assets/img/front-pages/landing-page/apple-icon.png" alt="apple icon"
              /></a>
              <a href="javascript:void(0);" class="d-block footer-link"
                ><img src="core-template/assets/img/front-pages/landing-page/google-play-icon.png" alt="google play icon"
              /></a>
            </div>
          </div>
        </div>
    ...
    <!-- Page JS -->
    <script src="core-template/assets/js/front-page-pricing.js"></script>
  </body>
</html>
