...
<html
  ...
  <head>
    ...
    <link rel="stylesheet" href="core-template/assets/vendor/css/pages/front-page-payment.css" />
  ...
  <body>
          ...
          <div class="row">
                  ...
                  <div class="form-check custom-option custom-option-basic checked">
                    <label
                      ...
                      <span class="custom-option-body">
                        <img
                          src="core-template/assets/img/icons/payments/visa-light.png"
                          alt="visa-card"
                          width="58"
                ...
                <div class="col-md">
                  <div class="form-check custom-option custom-option-basic">
                    <label
                      ...
                      <span class="custom-option-body">
                        <img
                          src="core-template/assets/img/icons/payments/paypal-light.png"
                          alt="paypal"
                          width="58"
            ...
            <div class="col-lg-5 card-body p-8 pt-0 pt-lg-8">
              ...
              <div class="bg-lighter p-6 rounded-4">
                ...
                <div class="d-grid">
                  <a data-bs-target="#pricingModal" data-bs-toggle="modal" class="btn btn-outline-primary text-primary"
                    >Change Plan</a
                  >
                </div>
              </div>
                  ...
                  <div class="card border shadow-none">
                    <div class="card-body pt-12">
                      <div class="mt-3 mb-5 text-center">
                        <img src="core-template/assets/img/illustrations/pricing-basic.png" alt="Basic Image" height="100" />
                      </div>
                      ...
                      <button type="button" class="btn btn-outline-success d-grid w-100" data-bs-dismiss="modal">
                        Your Current Plan
                      </button>
                    </div>
                  </div>
                  ...
                  <div class="card border-primary border shadow-none">
                    <div class="card-body position-relative pt-4">
                      ...
                      <div class="my-5 pt-6 text-center">
                        <img
                          src="core-template/assets/img/illustrations/pricing-standard.png"
                          alt="Standard Image"
                          height="100" />
                      </div>
                ...
                <div class="col-xl">
                  <div class="card border shadow-none">
                    <div class="card-body pt-12">
                      ...
                      <button type="button" class="btn btn-outline-primary d-grid w-100" data-bs-dismiss="modal">
                        Upgrade
                      </button>
                    </div>
                  </div>
    ...
    <script src="core-template/assets//js/pages-pricing.js"></script>
    ...
    <!-- Vendors JS -->
    <script src="core-template/assets/vendor/libs/cleavejs/cleave.js"></script>
    ...
    <!-- Page JS -->
    <script src="core-template/assets/js/pages-pricing.js"></script>
    <script src="core-template/assets/js/front-page-payment.js"></script>
  </body>
</html>
