...
<!-- Filter Section -->
@include("company-management.position.search")
      ...
      dataTableIndex = $(".dataTableIndex").DataTable({
          ...
          ajax: {
              ...
              data: {
                ...
                codes: () => { return $('#searchForm #codes').val() },
              },
              timeout: 60 * 1000
          },
          dom: `
              ...
              },
              {
                  ...
                  render: function(data, type, row, meta) {
                      ...
                      <div class="d-flex align-items-center gap-2">
                          ...
                          <i class="ri-delete-bin-7-line ri-20px pointer delete ${row.status.code == "Active" ? null : 'disabled' }" data-id="${row.id}" title="Delete"></i>
                      </div>`;
                  }
              },
             {
