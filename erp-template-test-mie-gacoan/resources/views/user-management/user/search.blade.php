...
<form id="searchForm" onsubmit="return false;">
  ...
  <div class="card card-body">
    ...
    <div class="row mb-3">
      ...
      <div class="col-md-4">
        <label for="filter-barcode" class="form-label">Full Name</label>
        <input type="text" id="names"  name="names" class="form-control" placeholder="Enter Full Name">
      </div>
     <div class="col-md-4">
        <label for="filter-barcode" class="form-label">Email</label>
        <input type="text" id="emails"  name="emails" class="form-control" placeholder="Enter Email">
      </div>
    </div>
