@include("user-management.user.dashboard")
...
<!-- Filter Section -->
@include("user-management.user.search")
    ...
    $(document).ready(function() {
      ...
      dataTableIndex = $(".dataTableIndex").DataTable({
          ...
          initComplete: function() {
            const btnGroup = $(`
                <div class="d-flex gap-2 ms-auto">
                    <button class="btn btn-primary" id="btnAdd" title="Add New" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddUser">
          ...
          columns: [
              ...
              //                 <i class="ri-delete-bin-7-line ri-20px pointer delete" data-id="${row.id}" title="Delete"></i>
              //                 <i class="ri-eye-line ri-20px pointer preview" data-id="${row.id}" title="Preview"></i>
              //                 <div class="dropdown">
              //                     <i class="ri-more-2-line" data-bs-toggle="dropdown" aria-expanded="false"></i>
              //                     <div class="dropdown-menu dropdown-menu-end">
              //                         <a class="dropdown-item view" href="#" data-id="${row.id}">
              //                             <i class="ri-eye-line me-2"></i> View
              //                         </a>
              //                         <a class="dropdown-item edit" href="#" data-id="${row.id}">
              //                             <i class="ri-edit-box-line me-2"></i> Edit
              //                         </a>
              //                         <a class="dropdown-item delete-dropdown" href="#" data-id="${row.id}">
              ...
              // },
              {
                  ...
                  render: function(data, type, row, meta) {
                      ...
                      <div class="d-flex align-items-center gap-2">
                          ...
                          <i class="ri-pencil-line me-1 pointer edit ${row.status ? 'disabled' : null }" data-id="${row.id}" title="Edit"></i>
                          <i class="ri-delete-bin-7-line ri-20px pointer delete ${row.status ? 'disabled' : null }" data-id="${row.id}" title="Delete"></i>
                      </div>`;
                  }
              },
             {
                ...
                render: function(data, type, row) {
                  const badgeClass = !data ? 'primary' : 'danger';
