      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg position-relative py-sm-12 px-12 py-6">
          ...
          <div class="w-px-400 mx-auto pt-5 pt-lg-0">
             <div class="app-brand justify-content-center mt-4 text-center">
              <a href="#" class="app-brand-link d-inline-block">
                <span class="app-brand-logo-login demo d-block mx-auto">
                  <span style="color: #666cff">
                    <img src="{{ asset('images/logo/miegacoan.png') }}" alt="Mie Gacoan Logo" style="height:200px; width: auto; display:block; margin:0 auto;">
                  </span>
                </span>
              </a>
            </div>
            <p class="mb-5 text-center" style="font-size:18px;">Mie Pedas No #1 di Indonesia</p>
