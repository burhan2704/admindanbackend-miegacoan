...
<form id="searchForm" onsubmit="return false;">
  ...
  <div class="card card-body">
    ...
    <div class="row mb-3">
      ...
      <div class="col-md-4">
        <label for="filter-barcode" class="form-label">Item Code</label>
        <input type="text" id="prd_code"  name="prd_code" class="form-control" placeholder="">
      </div>

      <div class="col-md-4">
        <label for="filter-barcode" class="form-label">Item Desc</label>
        <input type="text" id="prd_desc"  name="prd_desc" class="form-control" placeholder="">
      </div>
