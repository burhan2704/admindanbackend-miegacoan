    ...
    <div class="card-body demo-vertical-spacing demo-only-element">
      <div id="mainForm">
        <form enctype="multipart/form-data" method="POST" onsubmit="return false;">
            ...
            <div class="form-floating form-floating-outline mb-4" style="{{ $permission->isSuperAdmin ?? 'display: none;' }}">
                {!! Form::select('wh_type_id', [null=>"Select"] + Arr::pluck($warehouseTypes, 'code', 'id'), $header ? $header->wh_type_id :  Auth::user()->wh_type_id, [$disab, 'class' => 'select2 form-select', 'id' => 'wh_type_id']) !!}
                {!! Form::label('wh_type_id', 'Warehouse Type') !!}
            </div>
